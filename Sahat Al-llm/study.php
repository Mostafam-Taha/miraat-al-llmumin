                    ...
                    <div class="study-card-item">
                        <article class="card card-ar">
                            <section class="card__hero">
                                ...
                                <p style="text-align: right;" class="card__job-title">اللغة العربية</p>
                            </section>
                            <section class="card__footer">
                                <div class="card__job-summary">
                                    ...
                                    <div class="card__job">
                                        <p class="card__job-title">للصف الثالث الثانوي<br/></p>
                                    </div>
                                </div>
                                <button class="card__btn" onclick="window.open('study/arabic.html')">view</button>
                            </section>
                        </article>
                        <article class="card card-ch">
                            <section class="card__hero">
                                <div class="card__hero-header">
                                    <span>0 سؤال</span>
                                    <div class="card__icon">
                                ...
                                <p style="text-align: right;" class="card__job-title">الكيمياء</p>
                            </section>
                            <section class="card__footer">
                                <div class="card__job-summary">
                                    <div class="card__job-icon">
                                ...
                                <button class="card__btn" onclick="window.open('study/chemistry.html')">view</button>
                            </section>
                        </article>
                        </article>
                        <article class="card card-ph">
                            <section class="card__hero">
                                <div class="card__hero-header">
                                    <span>0 سؤال</span>
                                    <div class="card__icon">
                                ...
                                <p style="text-align: right;" class="card__job-title">الفيزياء</p>
                            </section>
                            <section class="card__footer">
                                <div class="card__job-summary">
                                    <div class="card__job-icon">
                                ...
                                <button class="card__btn" onclick="window.open('study/physics.html')">view</button>
                            </section>
                        </article>
                        <article class="card card-en">
                            <section class="card__hero">
                                <div class="card__hero-header">
                                    <span>0 سؤال</span>
                                    <div class="card__icon">
                                ...
                                <p style="text-align: right;" class="card__job-title">اللغة الأنجليزية</p>
                            </section>
                            <section class="card__footer">
                                <div class="card__job-summary">
                                    <div class="card__job-icon">
                                ...
                                <button class="card__btn" onclick="window.open('study/english.html')">view</button>
                            </section>
                        </article>
                    </div>
                </div>
